...
@Schema(description = "修改文章请求参数")
public class ArticleUpdateVo extends BaseParameterVo {
    ...
    @Schema(description = "删除的文件ID数组")
    private List<Integer> deletedFileIds;

    @Schema(description = "分类ID")
    private List<Integer> categoryIds;

    @Schema(description = "删除的分类ID")
    private List<Integer> deletedCategoryIds;
