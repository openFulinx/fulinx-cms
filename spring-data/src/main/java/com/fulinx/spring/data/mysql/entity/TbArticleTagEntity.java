...
@Schema(name = "TbArticleTagEntity", description = "Article Tag Table")
public class TbArticleTagEntity extends Model<TbArticleTagEntity> {

    private static final long serialVersionUID = 1L;

    @Schema(description = "Article Tag ID")
