...
@TableName("tb_article_category_relation")
@Schema(name = "TbArticleCategoryRelationEntity", description = "Article Category Relation Table")
public class TbArticleCategoryRelationEntity extends Model<TbArticleCategoryRelationEntity> {
