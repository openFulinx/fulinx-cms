...
@TableName("tb_category_seo")
@Schema(name = "TbCategorySeoEntity", description = "Category Seo Table")
public class TbCategorySeoEntity extends Model<TbCategorySeoEntity> {

    private static final long serialVersionUID = 1L;

    @Schema(description = "Category SEO ID")
