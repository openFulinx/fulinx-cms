...
@TableName("tb_article_slug")
@Schema(name = "TbArticleSlugEntity", description = "Article Slug Table")
public class TbArticleSlugEntity extends Model<TbArticleSlugEntity> {

    private static final long serialVersionUID = 1L;

    @Schema(description = "Article Slug ID")
