...
@TableName("tb_article_file_relation")
@Schema(name = "TbArticleFileRelationEntity", description = "Article File Relation Table")
public class TbArticleFileRelationEntity extends Model<TbArticleFileRelationEntity> {
