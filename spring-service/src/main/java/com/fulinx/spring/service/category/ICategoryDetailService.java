...
public interface ICategoryDetailService {
     ...
     */
    Optional<TbCategoryDetailEntity> create(Integer categoryId, Integer languageId, String categoryName, String categoryDescription) throws BusinessException;
     ...
     * @throws BusinessException
     */
    boolean update(Integer categoryId, Integer languageId, String categoryName, String categoryDescription) throws BusinessException;
